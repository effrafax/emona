...
public class IntegerValueAttributeImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.INTEGER_VALUE_ATTRIBUTE;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BasePackage.INTEGER_VALUE_ATTRIBUTE__COMMENT, oldComment,
					comment));
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BasePackage.INTEGER_VALUE_ATTRIBUTE__VALUE, oldValue, value));
	}
