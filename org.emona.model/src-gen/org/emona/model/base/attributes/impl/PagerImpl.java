...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pager</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PagerImpl extends ObjectContentImpl implements Pager {
	 ...
	 * @ordered
	 */
	protected static final String TOKEN_EDEFAULT = "pager";
	 ...
	 * @ordered
	 */
	protected static final InternetAddress VALUE_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected InternetAddress value = VALUE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.PAGER;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.PAGER__COMMENT, oldComment, comment));
	}
	...
	public void setToken(String newToken) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.PAGER__TOKEN, oldToken, token));
	}
	 ...
	 * @generated
	 */
	public InternetAddress getValue() {
		return value;
	}
	 ...
	 * @generated
	 */
	public void setValue(InternetAddress newValue) {
		InternetAddress oldValue = value;
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.PAGER__VALUE, oldValue, value));
	}
