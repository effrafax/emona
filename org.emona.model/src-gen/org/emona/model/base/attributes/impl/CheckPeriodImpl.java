...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Check Period</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emona.model.base.attributes.impl.CheckPeriodImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.CheckPeriodImpl#getToken <em>Token</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CheckPeriodImpl extends ReferenceAttributeImpl implements
		CheckPeriod {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TOKEN_EDEFAULT = "check_period";
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.CHECK_PERIOD;
	}
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AttributesPackage.CHECK_PERIOD__REFERENCE,
	...
	public void setReference(TimeperiodName newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.CHECK_PERIOD__REFERENCE, oldReference,
					reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AttributesPackage.CHECK_PERIOD__REFERENCE:
			if (resolve)
				return getReference();
			return basicGetReference();
		case AttributesPackage.CHECK_PERIOD__TOKEN:
			return getToken();
		}
