...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hostgroups</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emona.model.base.attributes.impl.HostgroupsImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostgroupsImpl#getToken <em>Token</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HostgroupsImpl extends ReferenceAttributeImpl implements
		Hostgroups {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TOKEN_EDEFAULT = "hostgroups";
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.HOSTGROUPS;
	}
	...
	public EList<HostgroupName> getReference() {
		if (reference == null) {
			reference = new EObjectResolvingEList<HostgroupName>(
					...
					AttributesPackage.HOSTGROUPS__REFERENCE);
		}
		return reference;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AttributesPackage.HOSTGROUPS__REFERENCE:
			return getReference();
		case AttributesPackage.HOSTGROUPS__TOKEN:
			return getToken();
		}
