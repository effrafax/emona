 ...
 *   <li>{@link org.emona.model.base.attributes.impl.NotificationFailureCriteriaImpl#getState <em>State</em>}</li>
 ...
 * @generated
 */
public class NotificationFailureCriteriaImpl extends ObjectContentImpl
		implements NotificationFailureCriteria {
	/**
	...
	public EList<ServiceStateValue> getState() {
		if (state == null) {
			state = new EDataTypeUniqueEList<ServiceStateValue>(
					...
					AttributesPackage.NOTIFICATION_FAILURE_CRITERIA__STATE);
		}
		return state;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AttributesPackage.NOTIFICATION_FAILURE_CRITERIA__MULTILINE:
			return isMultiline();
		case AttributesPackage.NOTIFICATION_FAILURE_CRITERIA__STATE:
			return getState();
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ServiceState.class) {
			...
			case BasePackage.SERVICE_STATE__STATE:
				return AttributesPackage.NOTIFICATION_FAILURE_CRITERIA__STATE;
			default:
				return -1;
			}
		}
