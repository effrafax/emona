 ...
 *   <li>{@link org.emona.model.base.attributes.impl.HostEscalationOptionsImpl#isMultiline <em>Multiline</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostEscalationOptionsImpl#getState <em>State</em>}</li>
 ...
 * @generated
 */
public class HostEscalationOptionsImpl extends ObjectContentImpl implements
	...
	public void setMultiline(boolean newMultiline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.HOST_ESCALATION_OPTIONS__MULTILINE,
	...
	public EList<HostStateValue> getState() {
		if (state == null) {
			state = new EDataTypeUniqueEList<HostStateValue>(
					...
					AttributesPackage.HOST_ESCALATION_OPTIONS__STATE);
		}
		return state;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AttributesPackage.HOST_ESCALATION_OPTIONS__COMMENT:
			return getComment();
		case AttributesPackage.HOST_ESCALATION_OPTIONS__MULTILINE:
			return isMultiline();
		case AttributesPackage.HOST_ESCALATION_OPTIONS__STATE:
			return getState();
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HostState.class) {
			...
			case BasePackage.HOST_STATE__STATE:
				return AttributesPackage.HOST_ESCALATION_OPTIONS__STATE;
			default:
				return -1;
			}
		}
