 ...
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceNotificationFailureCriteriaImpl#getState <em>State</em>}</li>
 ...
 * @generated
 */
public class ServiceNotificationFailureCriteriaImpl extends ObjectContentImpl
	...
	public EList<ServiceStateValue> getState() {
		if (state == null) {
			state = new EDataTypeUniqueEList<ServiceStateValue>(
					ServiceStateValue.class,
					this,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__STATE);
		}
		return state;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__MULTILINE:
			return isMultiline();
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__STATE:
			return getState();
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ServiceState.class) {
			...
			case BasePackage.SERVICE_STATE__STATE:
				return AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__STATE;
			default:
				return -1;
			}
		}
