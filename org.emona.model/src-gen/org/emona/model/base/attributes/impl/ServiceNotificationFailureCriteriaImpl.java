...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Service Notification Failure Criteria</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceNotificationFailureCriteriaImpl#isUnknown <em>Unknown</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceNotificationFailureCriteriaImpl#isPending <em>Pending</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceNotificationFailureCriteriaImpl#isNone <em>None</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceNotificationFailureCriteriaImpl#getToken <em>Token</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ServiceNotificationFailureCriteriaImpl extends EObjectImpl
		implements ServiceNotificationFailureCriteria {
	/**
	 ...
	 * @generated
	 */
	protected ServiceNotificationFailureCriteriaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.SERVICE_NOTIFICATION_FAILURE_CRITERIA;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__COMMENT,
					oldComment, comment));
	}
	...
	public void setOk(boolean newOk) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__OK,
					oldOk, ok));
	}
	...
	public void setWarning(boolean newWarning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__WARNING,
					oldWarning, warning));
	}
	...
	public void setCritical(boolean newCritical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__CRITICAL,
	...
	public void setUnknown(boolean newUnknown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__UNKNOWN,
					oldUnknown, unknown));
	}
	...
	public void setPending(boolean newPending) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__PENDING,
					oldPending, pending));
	}
	...
	public void setNone(boolean newNone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__NONE,
					oldNone, none));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__WARNING:
			return isWarning();
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__CRITICAL:
			return isCritical();
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__UNKNOWN:
			return isUnknown();
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__PENDING:
			return isPending();
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__NONE:
			return isNone();
		case AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__TOKEN:
			return getToken();
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ServiceState.class) {
			...
			case BasePackage.SERVICE_STATE__OK:
				return AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__OK;
			case BasePackage.SERVICE_STATE__WARNING:
				return AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__WARNING;
			case BasePackage.SERVICE_STATE__CRITICAL:
				return AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__CRITICAL;
			case BasePackage.SERVICE_STATE__UNKNOWN:
				return AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__UNKNOWN;
			default:
				return -1;
			}
		}
		if (baseClass == ServiceFailureCriteria.class) {
			...
			case BasePackage.SERVICE_FAILURE_CRITERIA__PENDING:
				return AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__PENDING;
			case BasePackage.SERVICE_FAILURE_CRITERIA__NONE:
				return AttributesPackage.SERVICE_NOTIFICATION_FAILURE_CRITERIA__NONE;
			default:
				return -1;
			}
		}
...
} //ServiceNotificationFailureCriteriaImpl
