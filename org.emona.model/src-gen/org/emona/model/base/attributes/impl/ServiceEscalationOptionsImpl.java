 ...
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#getState <em>State</em>}</li>
...
public class ServiceEscalationOptionsImpl extends EObjectImpl implements
	...
	public EList<ServiceStateValue> getState() {
		if (state == null) {
			state = new EDataTypeUniqueEList<ServiceStateValue>(
					...
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__STATE);
		}
		return state;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__MULTILINE:
			return isMultiline();
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__STATE:
			return getState();
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ServiceState.class) {
			...
			case BasePackage.SERVICE_STATE__STATE:
				return AttributesPackage.SERVICE_ESCALATION_OPTIONS__STATE;
			default:
				return -1;
			}
		}
