...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Service Escalation Options</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#isMultiline <em>Multiline</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#isOk <em>Ok</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#isWarning <em>Warning</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#isCritical <em>Critical</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#isUnknown <em>Unknown</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ServiceEscalationOptionsImpl#getToken <em>Token</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceEscalationOptionsImpl extends EObjectImpl implements
	 ...
	 * @generated
	 */
	protected ServiceEscalationOptionsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.SERVICE_ESCALATION_OPTIONS;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__COMMENT,
					oldComment, comment));
	}
	...
	public void setMultiline(boolean newMultiline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__MULTILINE,
	...
	public void setOk(boolean newOk) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__OK, oldOk, ok));
	}
	...
	public void setWarning(boolean newWarning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__WARNING,
					oldWarning, warning));
	}
	...
	public void setCritical(boolean newCritical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__CRITICAL,
	...
	public void setUnknown(boolean newUnknown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__UNKNOWN,
					oldUnknown, unknown));
	}
	...
	public void setToken(String newToken) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.SERVICE_ESCALATION_OPTIONS__TOKEN,
					oldToken, token));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__COMMENT:
			return getComment();
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__MULTILINE:
			return isMultiline();
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__OK:
			return isOk();
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__WARNING:
			return isWarning();
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__CRITICAL:
			return isCritical();
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__UNKNOWN:
			return isUnknown();
		case AttributesPackage.SERVICE_ESCALATION_OPTIONS__TOKEN:
			return getToken();
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ServiceState.class) {
			...
			case BasePackage.SERVICE_STATE__OK:
				return AttributesPackage.SERVICE_ESCALATION_OPTIONS__OK;
			case BasePackage.SERVICE_STATE__WARNING:
				return AttributesPackage.SERVICE_ESCALATION_OPTIONS__WARNING;
			case BasePackage.SERVICE_STATE__CRITICAL:
				return AttributesPackage.SERVICE_ESCALATION_OPTIONS__CRITICAL;
			case BasePackage.SERVICE_STATE__UNKNOWN:
				return AttributesPackage.SERVICE_ESCALATION_OPTIONS__UNKNOWN;
			default:
				return -1;
			}
		}
