...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Parents</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emona.model.base.attributes.impl.ParentsImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.ParentsImpl#getToken <em>Token</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ParentsImpl extends ReferenceAttributeImpl implements Parents {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TOKEN_EDEFAULT = "parents";
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.PARENTS;
	}
	...
	public EList<HostName> getReference() {
		if (reference == null) {
			reference = new EObjectResolvingEList<HostName>(HostName.class,
					this, AttributesPackage.PARENTS__REFERENCE);
		}
		return reference;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AttributesPackage.PARENTS__REFERENCE:
			return getReference();
		case AttributesPackage.PARENTS__TOKEN:
			return getToken();
		}
