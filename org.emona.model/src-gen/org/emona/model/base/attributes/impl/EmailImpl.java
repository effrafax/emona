 ...
 * @generated
 */
public class EmailImpl extends ObjectContentImpl implements Email {
	/**
	 ...
	 * @ordered
	 */
	protected static final String TOKEN_EDEFAULT = "email";
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.EMAIL;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.EMAIL__COMMENT, oldComment, comment));
	}
	...
	public void setValue(InternetAddress newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.EMAIL__VALUE, oldValue, value));
	}
