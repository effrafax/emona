 ...
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#getState <em>State</em>}</li>
...
public class HostExecutionFailureCriteriaImpl extends ObjectContentImpl
	...
	public EList<HostStateValue> getState() {
		if (state == null) {
			state = new EDataTypeUniqueEList<HostStateValue>(
					...
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__STATE);
		}
		return state;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__MULTILINE:
			return isMultiline();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__STATE:
			return getState();
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HostState.class) {
			...
			case BasePackage.HOST_STATE__STATE:
				return AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__STATE;
			default:
				return -1;
			}
		}
