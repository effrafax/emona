...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Host Execution Failure Criteria</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#isMultiline <em>Multiline</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#isUp <em>Up</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#isDown <em>Down</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#isUnreachable <em>Unreachable</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#isPending <em>Pending</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#isNone <em>None</em>}</li>
 *   <li>{@link org.emona.model.base.attributes.impl.HostExecutionFailureCriteriaImpl#getToken <em>Token</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HostExecutionFailureCriteriaImpl extends EObjectImpl implements
	 ...
	 * @ordered
	 */
	protected static final String TOKEN_EDEFAULT = "execution_failure_criteria";
	 ...
	 * @generated
	 */
	protected HostExecutionFailureCriteriaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AttributesPackage.Literals.HOST_EXECUTION_FAILURE_CRITERIA;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__COMMENT,
					oldComment, comment));
	}
	...
	public void setMultiline(boolean newMultiline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__MULTILINE,
	...
	public void setUp(boolean newUp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__UP,
					oldUp, up));
	}
	...
	public void setDown(boolean newDown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__DOWN,
					oldDown, down));
	}
	...
	public void setUnreachable(boolean newUnreachable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__UNREACHABLE,
	...
	public void setPending(boolean newPending) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__PENDING,
					oldPending, pending));
	}
	...
	public void setNone(boolean newNone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__NONE,
					oldNone, none));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__COMMENT:
			return getComment();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__MULTILINE:
			return isMultiline();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__UP:
			return isUp();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__DOWN:
			return isDown();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__UNREACHABLE:
			return isUnreachable();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__PENDING:
			return isPending();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__NONE:
			return isNone();
		case AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__TOKEN:
			return getToken();
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HostState.class) {
			...
			case BasePackage.HOST_STATE__UP:
				return AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__UP;
			case BasePackage.HOST_STATE__DOWN:
				return AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__DOWN;
			case BasePackage.HOST_STATE__UNREACHABLE:
				return AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__UNREACHABLE;
			default:
				return -1;
			}
		}
		if (baseClass == HostFailureCriteria.class) {
			...
			case BasePackage.HOST_FAILURE_CRITERIA__PENDING:
				return AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__PENDING;
			case BasePackage.HOST_FAILURE_CRITERIA__NONE:
				return AttributesPackage.HOST_EXECUTION_FAILURE_CRITERIA__NONE;
			default:
				return -1;
			}
		}
...
} //HostExecutionFailureCriteriaImpl
